...
Backend-focused developer with hands-on experience in building APIs, web applications, and data-driven tools.  
I learn by building, iterate fast, and focus on clean, practical implementations.

## About
- Interested in backend systems, APIs, and applied AI
- Experience across frontend, backend, data, and design tools
- Project-first learner with hackathon exposure
- Focused on consistency and real-world problem solving
